...
import { Document, Page, Text, View, StyleSheet, Font, Link, Image, Svg, Path, Circle } from '@react-pdf/renderer';
      ...
      const page = (
        <Page size="A4" style={styles.page} wrap key={`${bookName}-${chapter.chapter}`}>          
          ...
          {/* Verses */}
            ...
            <View  key={`${bookName}-${chapter.chapter}-${verse.verse}`}>
                {/* <View style={styles.leftColumn}> */}
