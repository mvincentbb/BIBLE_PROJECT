...
// Corrected font paths for server-side rendering
Font.register({
  family: 'Itim',
            ...
            <Page size="A4" style={styles.page} wrap>
              ...
              <View fixed style={styles.footer}>
                <View style={styles.footerLeft}>
                  ...
                  <Image src={path.resolve(process.cwd(), 'public/youtubeIcon.png')} style={styles.socialIcon} alt="YouTube" />
                  <Image src={path.resolve(process.cwd(), 'public/xIcon.png')} style={styles.socialIcon} alt="YouTube" />
                  <Image src={path.resolve(process.cwd(), 'public/metaIcon.png')} style={styles.socialIcon} alt="YouTube" />
                  <Image src={path.resolve(process.cwd(), 'public/instagramIcon.png')} style={styles.socialIcon} alt="YouTube" />
...
export default BibleBookDocument;
